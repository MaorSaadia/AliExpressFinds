    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="relative hidden md:block">
        ...
        >
          <Search
            className={`
              mr-3 h-4 w-4 flex-shrink-0 transition-colors duration-300 hover:cursor-pointer
          ...
          <input
            ...
            className={`
              w-full bg-transparent px-3 py-2 text-sm outline-none text-right
                ...
                <div className="flex-1">
                  <div className="relative flex items-center overflow-hidden rounded-full border border-gray-200 bg-gray-50 dark:bg-stone-800">
                    ...
                    <input
                      ...
                      onChange={(e) => setSearchValue(e.target.value)}
                      placeholder="חפש מוצרים..."
                      className="w-full bg-transparent px-3 py-2 text-sm outline-none text-right"
                      autoFocus
                      dir="rtl"
                    />
                    {searchValue && (
