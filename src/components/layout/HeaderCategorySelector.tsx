...
const HeaderCategorySelector = async ({
  ...
  return (
    <>
      {/* Desktop dropdown */}
      <div className="relative hidden md:inline-block" dir="rtl">
        ...
        <div className="absolute right-0 top-full z-50 mt-1 opacity-0 invisible peer-hover:opacity-100 peer-hover:visible hover:opacity-100 hover:visible transition-all duration-200 ease-in-out">
          <div className="flex">
              ...
              <div className="py-2">
                {categories.map((category) => (
                  <div key={category._id} className="relative group/category">
                    ...
                    {category.subcategories?.length > 0 && (
                      <div className="absolute right-full top-0 mr-0.5 invisible opacity-0 group-hover/category:visible group-hover/category:opacity-100 transition-all duration-200">
                        <div className="w-72 bg-white dark:bg-stone-800 border rounded-lg shadow-lg">
                          <div className="p-4 border-b dark:border-stone-700">
                            <h3 className="font-semibold text-gray-900 dark:text-gray-200">
                              {category.title}
